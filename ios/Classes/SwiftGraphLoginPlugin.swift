...
enum PluginMethod: String {
    case logIn, logOut, setAppId, getAccessToken, getUserProfile, getUserEmail, getSdkVersion, getProfileImageUrl
}
...
public class SwiftGraphLoginPlugin: NSObject, FlutterPlugin {
    ...
    public func handle(_ call: FlutterMethodCall, result: @escaping FlutterResult) {
        ...
        case .setAppId:
            guard
                let args = call.arguments as? [String: Any],
                let appIdArg = args[SetAppIdArg.appIdArg.rawValue] as? String
                else {
                    result(FlutterError(code: "INVALID_ARGS",
                                        message: "Arguments is invalid",
                                        details: nil))
            ...
            setAppId(result: result, appId: appIdArg)
        case .logOut:
